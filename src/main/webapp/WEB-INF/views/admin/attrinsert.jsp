...
<table>
		<c:if test="${num ==1 }">
 				...
 				<tr>
					<td >이름</td>
					<td align="left"><input type="text" name="itemname" value="${item.itemname }" readonly="readonly"/></td>
				</tr>
 				<tr>
					<td >아이템 코드</td>
					<td align="left"><input type="text" id ="itemcode" name="itemcode" /></td>
				</tr>
 				<tr>
					<td >색/용량</td>
			...
			<c:if test="${num ==2 }">
				...
				<tr>
					<td>아이템 코드</td>
					<td align="left"><input type="text" id ="itemcode" name="itemcode" value="${item.itemcode }" readonly="readonly"/></td>
				</tr>
				<tr>
					<td>색/용량</td>
					<td align="left"><input type="text" name="itemcolor" value="${item.itemcolor }"/></td>
				</tr>
				<tr>
					<td>가격</td>
					<td align="left"><input type="text" name="itemcost" value="${item.itemcost }"/></td>
				</tr>
				<tr>
					<td>잔고</td>
					<td align="left"><input type="text" name="itemstock" value="${item.itemstock }"/></td>
				</tr>
			</c:if>
...
$(document).ready(function() {
         ...
         $(".insert_button").click(function() {
            $("#update").attr("action", "/itemattrAction");
            $("#update").submit();
